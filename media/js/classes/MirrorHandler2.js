(function () {
    class MirrorHandler {
        ...
        query ( data ) {
            return this.rest.send (this.resource, "get", data);
        }
        create (data) {
            return this.rest.send (this.resource, "post", data);
        }
        remove (data) {
            return this.rest.send (this.resource, "delete", data);
        }
        update (data) {
            return this.rest.send (this.resource, "put", data);
        }
    }
